              ...
              slivers: <Widget>[
                SliverPersistentHeader(
                    ...
                    delegate: SliverHeadDelegate(
                        minHeight: Screens.setHeight(80),
                        maxHeight: Screens.setHeight(130),
                        child: Card(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ImageHelper.getImage(
                                        ...
                                        height: Screens.setHeight(60),
                                        isRound: true),
                                    Padding(padding: EdgeInsets.only(right: Screens.setWidth(20))),
                                    Expanded(
                                        child: Wrap(
                                      direction: Axis.vertical,
                                      children: <Widget>[
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          child: Wrap(
                            ...
                            children: <Widget>[
                              Container(
                                padding: EdgeInsets.only(right: Screens.width15),
                                child: ImageHelper.getImage(
                                    state.createOrderList[index].coverImgUrl + "?param=280y280",
                                    height: Screens.setHeight(100)),
                              ),
                              Container(
                                height: Screens.setHeight(40),
                                constraints: BoxConstraints(maxWidth: Screens.setHeight(95)),
                                alignment: Alignment.centerLeft,
                                child: Text(
                          ...
                          onTap: () {
                            Navigator.of(viewService.context).pushNamed('sheet_details',
                                arguments: {'sheetId': state.createOrderList[index].id}); //注意
                          },
                        );
                      },
...
Widget _orderItem(UserOrderPlaylist orderPlaylist, viewService) {
  return InkWell(
    child: Container(
      padding: EdgeInsets.symmetric(vertical: Screens.height10,horizontal: Screens.width5),
      child: Row(
        children: <Widget>[
         ...
         Expanded(child:  Column(
           children: <Widget>[
             Container(
                 ...
                 child: Text(orderPlaylist.name, style: TextStyle(fontSize: Screens.text12))),
             Container(
                 alignment: Alignment.centerLeft,
                 height: Screens.setHeight(20),
...
//    leading: ImageHelper.getImage(orderPlaylist.coverImgUrl + "?param=80y80",
//        height: Screens.setHeight(40), isRound: true),
//    title: Text(
//      orderPlaylist.name,
//      style: TextStyle(fontSize: Screens.text12),
//    ),
...
//    onTap: () {
//      Navigator.of(viewService.context)
//          .pushNamed('sheet_details', arguments: {'sheetId': orderPlaylist.id}); //注意
//    },
//  );
}
