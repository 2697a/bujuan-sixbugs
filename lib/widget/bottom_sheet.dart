...
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showMyModalBottomSheet].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showMyModalBottomSheet], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showMyModalBottomSheet], for modal bottom sheets.
  const BottomSheet({
    Key key,
...
/// [showMyModalBottomSheet] function.
///
