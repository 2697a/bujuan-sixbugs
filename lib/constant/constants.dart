...
const String BLUR = 'BLUR';//模糊度

const String COOKIE = 'COOKIE';

const String HIGH = 'HIGH';//高音质

const String MINI_PLAY = 'MINNI_PLAY';//迷你播放页

const String IS_SHOW_SUN = 'IS_SHOW_SUN';//是否显示日夜间的太阳

const String USER_ID = 'USER_ID';//用户id

const String USER_BACKGROUND = 'USER_BACKGROUND';//用户背景

const String MINI_NAV = 'MINI_NAV';//迷你导航栏

const String BOTTOM_NAV = 'BOTTOM_NAV';//底部导航栏

const String PLAY_MODE = 'PLAY_MODE';//播放模式

const String LIKE_SONGS = 'LIKE_SONGS';//喜欢的歌曲ids

const String ISFM = 'ISFM';//是否是FM

const String LOCAL_SHEET = 'LOCAL_SHEET';

const String bs_top = 'http://p1.music.126.net/DrRIg6CrgDfVLEph9SNh7w==/18696095720518497.jpg?param=300y200';

const String new_top = 'http://p1.music.126.net/N2HO5xfYEqyQ8q6oxCw8IQ==/18713687906568048.jpg?param=300y200';

const String yc_top = 'http://p1.music.126.net/sBzD11nforcuh1jdLSgX7g==/18740076185638788.jpg?param=300y200';

const String hot_top = 'http://p2.music.126.net/GhhuF6Ep5Tq9IEvLsyCN7w==/18708190348409091.jpg?param=300y200';

const String dy_top = 'http://p1.music.126.net/5tgOCD4jiPKBGt7znJl-2g==/18822539557941307.jpg?param=200y200';

const String uk_top = 'http://p2.music.126.net/VQOMRRix9_omZbg4t-pVpw==/18930291695438269.jpg?param=200y200';

const String billl_top = 'http://p1.music.126.net/EBRqPmY8k8qyVHyF8AyjdQ==/18641120139148117.jpg?param=200y200';

const String krv_top = 'http://p1.music.126.net/H4Y7jxd_zwygcAmPMfwJnQ==/19174383276805159.jpg?param=200y200';
