...
public final class PrefUtils{
     ...
     * @param datalist
     */
//    public static void setDataList(Context context, String key, List<String> datalist) {
//        if (null == datalist || datalist.size() <= 0){
//            removeDataList(context,key);
//            return;
//        }
//        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
//        //转换成json数据，再保存
//        String strJson = GsonUtils.toJson(datalist);
//        prefs.edit().putString(key, strJson).apply();
//
//    }
//
//    /**
...
//     * @return
//     */
//    public static List<String> getDataList(Context context, String key) {
...
//            return datalist;
//        }
//        datalist = GsonUtils.fromJson(strJson, new TypeToken<List<String>>() {}.getType());
//        return datalist;
//    }
     ...
     */
    public static void removeDataList(Context context, String key){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit().remove(key).apply();
    }
}