...
import com.sixbugs.flutterstarrysky.starry.MusicService
import com.sixbugs.flutterstarrysky.starry.R
import com.sixbugs.flutterstarrysky.starry.StarrySky
import com.sixbugs.flutterstarrysky.starry.ext.albumArt
import com.sixbugs.flutterstarrysky.starry.ext.albumArtUrl
import com.sixbugs.flutterstarrysky.starry.ext.id
import com.sixbugs.flutterstarrysky.starry.imageloader.ImageLoaderCallBack
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_CLOSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_DOWNLOAD
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_FAVORITE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_LYRICS
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_NEXT
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_PAUSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_PLAY
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_PLAY_OR_PAUSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_PREV
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ACTION_STOP
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.CHANNEL_ID
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_DOWNLOAD
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_FAVORITE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_LYRICS
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_NEXT_PRESSED
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_NEXT_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_PAUSE_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_PLAY_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_PREV_PRESSED
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_DARK_PREV_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_FAVORITE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_DOWNLOAD
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_FAVORITE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_LYRICS
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_NEXT_PRESSED
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_NEXT_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_PAUSE_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_PLAY_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_PREV_PRESSED
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LIGHT_PREV_SELECTOR
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.DRAWABLE_NOTIFY_BTN_LYRICS
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_CLOSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_DOWNLOAD
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_FAVORITE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_ICON
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_LYRICS
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_NEXT
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_PAUSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_PLAY
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_PLAY_OR_PAUSE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_PRE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_IMG_NOTIFY_STOP
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_TXT_NOTIFY_ARTISTNAME
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.ID_TXT_NOTIFY_SONGNAME
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.LAYOUT_NOTIFY_BIG_PLAY
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.LAYOUT_NOTIFY_PLAY
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.NOTIFICATION_ID
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.REQUEST_CODE
import com.sixbugs.flutterstarrysky.starry.notification.INotification.Companion.TIME_INTERVAL
import com.sixbugs.flutterstarrysky.starry.notification.utils.NotificationColorUtils
import com.sixbugs.flutterstarrysky.starry.notification.utils.NotificationUtils
