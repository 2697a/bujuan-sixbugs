package com.sixbugs.flutterstarrysky.starry.provider
...
class SongInfo(
    ...
    companion object : Parceler<SongInfo> {

        override fun SongInfo.write(parcel: Parcel, flags: Int) {
        ...
        override fun create(parcel: Parcel): SongInfo {
